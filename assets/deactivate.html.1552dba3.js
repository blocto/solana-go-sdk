import{_ as n,e as s}from"./app.aa4fcc9f.js";const a={},t=s(`<h1 id="deactivate-unstake" tabindex="-1"><a class="header-anchor" href="#deactivate-unstake" aria-hidden="true">#</a> Deactivate (unstake)</h1><div class="custom-container tip"><p class="custom-container-title">TIP</p><p>Activation requires waiting for 1 epoch. You can use <code>solana-test-validator --slot-per-epoch &lt;SLOT&gt;</code> for test.</p></div><div class="language-go ext-go line-numbers-mode"><pre class="language-go"><code><span class="token keyword">package</span> main
